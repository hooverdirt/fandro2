...
namespace Fandro2.lib.WinAPI {
    ...
    public interface IAutoComplete2 /*: IAutoComplete */
    {
        ...
        [PreserveSig]
        int Enable(
            int fEnable);                         // Value that is set to TRUE to enable autocompletion, or to 
                                                  // FALSE to disable it. 
        ...
        [PreserveSig]
        int SetOptions(
            uint dwFlag);         // Flags that allow an application to specify autocomplete options. 
        ...
        [PreserveSig]
        int GetOptions(
            out uint pdwFlag);    // that indicate the options that are currently set. 
